package me.xx2bab.polyfill.arsc1;

import me.xx2bab.polyfill.arsc1.util.BytesReader;
import me.xx2bab.polyfill.arsc1.util.Utils;
import me.xx2bab.polyfill.arsc1.bean.ResArsc;
import me.xx2bab.polyfill.arsc1.bean.ResChunkHeader;
import me.xx2bab.polyfill.arsc1.bean.ResSpanStyle;
import me.xx2bab.polyfill.arsc1.bean.ResStringPoolHeader;
import me.xx2bab.polyfill.arsc1.bean.ResTableEntry;
import me.xx2bab.polyfill.arsc1.bean.ResTableHeader;
import me.xx2bab.polyfill.arsc1.bean.ResTableMap;
import me.xx2bab.polyfill.arsc1.bean.ResTableMapEntry;
import me.xx2bab.polyfill.arsc1.bean.ResTablePackageHeader;
import me.xx2bab.polyfill.arsc1.bean.ResTableType;
import me.xx2bab.polyfill.arsc1.bean.ResTableTypeSpec;
import me.xx2bab.polyfill.arsc1.bean.ResType;
...
import static me.xx2bab.polyfill.arsc1.util.Reader.log;

/**
 * https://github.com/lulululbj/android-reverse/tree/master/Parser/src/main/luyao/parser/arsc
 *
 * Created by luyao
 * on 2018/12/20 13:43
 */
public class ResParser {
    ...
    public static void main(String[] args) {
        ResParser parser = new ResParser(new File("/Users/2bab/Desktop/resources.arsc"));
        parser.parse();
    }
